...
#######################################
	...
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=cli_tester_sam9xe512ek
	@echo ""
	@echo ""
	...
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=cli_tester_nrf52dk
	@echo ""
	@echo ""
	...
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/config CONFIG_NAME=ubinos_stm3221geval_baremetal_sram
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/config CONFIG_NAME=ubinos_stm3221geval_baremetal
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/config CONFIG_NAME=ubinos_stm3221geval
	@echo ""
	@echo ""
	...
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=helloworld_stm3221geval_baremetal
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=helloworld_stm3221geval_baremetal_sram
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	...
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=ubik_tester_stm3221geval
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=cli_tester_stm3221geval
	@echo ""
	@echo ""
	...
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/config CONFIG_NAME=ubinos_nucleof207zg_baremetal_sram
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/config CONFIG_NAME=ubinos_nucleof207zg_baremetal
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/config CONFIG_NAME=ubinos_nucleof207zg
	@echo ""
	@echo ""
	...
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=helloworld_nucleof207zg_baremetal
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=helloworld_nucleof207zg_baremetal_sram
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	...
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=ubik_tester_nucleof207zg
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/ubinos/app CONFIG_NAME=cli_tester_nucleof207zg
	@echo ""
	@echo ""
...
#######################################
	...
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/stm32cubef2/config CONFIG_NAME=stm32cubef2_stm3221geval_baremetal
	@echo ""
	@echo ""
	@echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
	@echo ""
	@echo ""
	make -f makefile.mk $@ CONFIG_DIR=../library/stm32cubef2/config CONFIG_NAME=stm32cubef2_nucleof207zg_baremetal
	@echo ""
	@echo ""
