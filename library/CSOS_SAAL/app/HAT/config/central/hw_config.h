...
#define HAT_TWI_SCL			NRF_GPIO_PIN_MAP(0,7)
#define HAT_TWI_SDA			NRF_GPIO_PIN_MAP(0,8)

#define HAT_LPS_INT			NRF_GPIO_PIN_MAP(0,23)
#define HAT_HTS_INT			NRF_GPIO_PIN_MAP(0,24)
#define HAT_LIS_INT			NRF_GPIO_PIN_MAP(0,9)
